                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                            @if (auth()->user()->gerenciar)
    <a href="/users">
        <div class="card mb-4 rounded card-icones"
             onmouseenter="alterarUsuarios(true, 'usuarios')"
             onmouseleave="alterarUsuarios(false, 'usuarios')">
            <img class="card-img-top" src="{{URL::asset('/images/usuariosVerde.png')}}" style="transform: scale(0.8)"
                 alt="Users Pic" id="usuarios">
            <div class="card-body d-flex flex-column justify-content-between">
                <h5 class="card-title text-white">Gerenciar Usuários</h5>
            </div>
        </div>
    </a>
    @endif
            ...
            @push('js')
                <script>
                    ...
                    function alterarUsuarios(hover, element) {
    var img = document.getElementById(element);

    if (hover) {
        img.src = "{{URL::asset('images/usuarios.png')}}";
    } else {
        img.src = "{{URL::asset('images/usuariosVerde.png')}}";
    }
}
